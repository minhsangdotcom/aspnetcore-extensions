...
public partial class StringExtension
{
    ...
    public static IEnumerable<QueryResult> TransformStringQuery(string[] queries, string filterKey)
    {
        return queries.Select(query =>
        {
            ...
            string[] keyList = queryString
                .Key.Trim()
                .Replace(filterKey, string.Empty, StringComparison.OrdinalIgnoreCase)
